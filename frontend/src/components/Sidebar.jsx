...
function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Menu Button - แสดงเฉพาะเมื่อเมนูปิดอยู่ */}
      {!mobileOpen && (
            ...
            {collapsed ? (
              ...
              <>
                <div className="flex items-center justify-between w-full">
                  ...
                  {/* Mobile Close Button - แสดงเฉพาะเมื่อเมนูเปิดอยู่ใน mobile */}
                  {mobileOpen && (
                    <button
                  ...
                  {/* Desktop Close Button - แสดงเฉพาะเมื่อไม่ได้ collapse ใน desktop */}
                  {!collapsed && (
                    <button
